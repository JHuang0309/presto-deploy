            ...
            <div className='lg:flex lg:items-center lg:justify-between pb-6 pl-6 pr-6'>
                <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                        <Link to='/dashboard' className="mt-2 flex items-center text-sm text-gray-500">
                        ...
                        <button className="mt-2 flex items-center text-sm text-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400">
